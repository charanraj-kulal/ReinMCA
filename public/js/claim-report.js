    ...
    if(CANCELLED_REQUEST == true){
     ...
     last_params = params;
      REPORT_AJAX=jQuery.ajax({
                    url: Settings.base_url+'reports/process_report',
                    type: 'POST',
                    data: params,
                    dataType: 'json',
...
$("#salesReport").tableHTMLExport({type:'pdf',filename:'Claim_Wise_Report.pdf',name:"Report",orientation:"l"});
}